...
;in Rebol result of POWER is always decimal (so far)
===start-group=== "power integer"
	--test-- "power-integer-1"	--red-- --assert integer? power 2 16
	--test-- "power-integer-2"	--red-- --assert integer? power 2 15
	--test-- "power-integer-3"	--red-- --assert integer? power 3 15
	--test-- "power-integer-4"	--red-- --assert integer? power 16 4
	--test-- "power-integer-5"	--red-- --assert integer? power 7 8
	--test-- "power-integer-6"	--red-- --assert integer? power 11 8
	--test-- "power-integer-7"	--red-- --assert integer? power 23 4
	--test-- "power-integer-8"	--red-- --assert integer? power 216 2
===end-group===
